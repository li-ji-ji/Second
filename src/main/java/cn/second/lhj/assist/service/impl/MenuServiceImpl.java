package cn.second.lhj.assist.service.impl;
...
import cn.second.lhj.assist.mapper.MenuMapperExtends;
import cn.second.lhj.assist.po.Menu;
import cn.second.lhj.assist.po.MenuExample;
import cn.second.lhj.assist.service.MenuService;
...
public class MenuServiceImpl implements MenuService {
	...
	public List<MenuVM> getMenuVMAll() throws Exception {
		...
		List<Menu> menus=menuMapper.getMenuListByPidAndStatus(0, 1);
	...
	public List<Menu> getMenuEnableByPid(Integer pid) throws Exception {
		// TODO 根据父级菜单查询已启用菜单
		return menuMapper.getMenuListByPidAndStatus(pid, 1);
	}

	@Override
	public List<Menu> getMenuNotEnableByPid(Integer pid) throws Exception {
		// TODO 根据父级菜单查询未启用菜单
		return menuMapper.getMenuListByPidAndStatus(pid, 0);
	}
