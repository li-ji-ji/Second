  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${base}/apply/updateApplyOne">  
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="${apply.id}" readonly name="id" data-validate="required:请输入标题" />
        </div>
      </div>
      ...
      <if condition="$iscid eq 1">
        <div class="form-group">
          ...
          <div class="field">
          	<input type="text" class="input w50" value="${apply.kindName}" readonly id="kindName" name="kindName" onclick="openKindList(this)" data-validate="required:请输入标题" />
    ...
    <div class="form-group">
       ...
       <div class="field">
         <input type="text" class="input w50" value="${apply.stuId}" name="stuId" data-validate="required:请输入标题" />
       </div>
    </div>
    ...
    <div class="form-group">
          ...
          <div class="field">
            <select name="status" class="input w50">
            	...
            	<option value="1" <#if apply.status== 1>selected</#if>>已通过</option>
            	<option value="2" <#if apply.status== 2>selected</#if>>申诉中</option>
            	<option value="3" <#if apply.status== 3>selected</#if>>已取消</option>
            </select>
            <div class="tips"></div>
          </div>
    </div>
    <div class="form-group">
          ...
          <div class="field">
            <select name="checkStatus" class="input w50">
            	...
            	<option value="1" <#if apply.checkStatus== 1>selected</#if>>已通过</option>
            	<option value="2" <#if apply.checkStatus== 2>selected</#if>>已驳回</option>
            </select>
            <div class="tips"></div>
          </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="${apply.supportDoc}" name="supportDoc"/>
          <div class="tips"></div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="${apply.supportFile}" name="supportFile"/>
          <div class="tips"></div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" readonly value="${apply.integral}" id="integral" name="integral" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
    </div>
